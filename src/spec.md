...
- Delete services through a prominently visible red "X" delete button positioned outside and beside the "Kelola Antrian" button for each service card
...
- Prominently visible red "X" delete button positioned outside and beside the "Kelola Antrian" button for each service card
...
- Frontend delete button conditional enabling based on service status with clear visibility positioned outside and beside the "Kelola Antrian" button
